...
#frame highscores
highscoresB1 = Button(highscores, text='switch test ding', command=lambda:raise_frame(highscores)).pack(pady=10)
highscoreL1 = Label(highscores, text='highscores').pack(pady=10)
